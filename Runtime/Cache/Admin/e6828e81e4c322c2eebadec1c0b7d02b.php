...
<form action="<?php echo U('update');?>" method="post" enctype="multipart/form-data" class="form-data" id="j-fmData">
    ...
    <div class="tab-content">
        <div class="tab-pane active" id="pane1">
            <table class="table table-condensed tb-data">
                <tr>
                    ...
                    <td><input type="text" name="type_name" value="<?php echo (htmlspecialchars($data["type_name"])); ?>" class="form-control-sm" /></td>
                </tr>
                <tr>
        ...
        <div class="tab-pane" id="pane2">
            <table class="table table-condensed table-bordered tb-data-list" id="js-type-attribute-list" data-choose-url="<?php echo U('chooseattribute');?>">
                <thead>
                    <tr>
                ...
                <tbody>
                <?php if(is_array($data["_attributes"])): $i = 0; $__LIST__ = $data["_attributes"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr data-id="<?php echo ($v["id"]); ?>">
                        ...
                        <td class="f16">
                            ...
                            <input type="hidden" name="attributes[]" value="<?php echo ($v["id"]); ?>">
                        </td>
