            ...
            <table class="table table-condensed tb-data">
                <tr>
                    ...
                    <td>
                        ...
                        <label><input type="radio" name="display" value="0" /> 图像</label>
                    </td>
                </tr>
                <tr>
                    <th><?php echo L('NAME');?></th>
                    <td><input type="text" name="spec" class="form-control-sm" /></td>
                </tr>
                <tr>
                    <th><?php echo L('ALIAS');?></th>
                    <td><input type="text" name="spec_alias" class="form-control-sm" /></td>
                </tr>
                <tr>
