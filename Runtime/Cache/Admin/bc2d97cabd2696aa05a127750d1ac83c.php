        ...
        <table class="table table-condensed table-hover tb-list">
            <thead>
                <tr>
                    ...
                    <th class="th-150"><?php echo L('START_TIME');?></th>
                    <th class="th-150"><?php echo L('END_TIME');?></th>
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td><?php echo ($v["id"]); ?></td>
                    <td><a href="<?php echo U('edit',array('id'=>$v['id']));?>"><?php echo ((isset($v["promotion"]) && ($v["promotion"] !== ""))?($v["promotion"]):'== 未定义 =='); ?></a></td>
