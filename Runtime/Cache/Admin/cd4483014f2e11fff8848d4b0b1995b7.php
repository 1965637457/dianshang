...
<div class="page-direction clearfix">
    ...
    <form action="" method="get" class="list-search">
        <select name="level_id" class="form-control-sm">
            <option value="-1">==选择会员等级==</option>
            <?php if(is_array($level_list)): $i = 0; $__LIST__ = $level_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v["id"]); ?>" <?php if(($v["id"]) == $opts["level_id"]): ?>selected<?php endif; ?>><?php echo ($v["member_level"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
        </select>
        ...
        <table class="table table-condensed table-hover tb-list">
            <thead>
                <tr>
                    ...
                    <th class="th-150"><?php echo L('USERNAME');?></th>
                    <th class="th-150"><?php echo L('LEVEL');?></th>
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td><?php echo ($v["id"]); ?></td>
                    <td><a href="<?php echo U('edit',array('id'=>$v['id']));?>"><?php echo ((isset($v["account"]) && ($v["account"] !== ""))?($v["account"]):'== 未定义 =='); ?></a></td>
                    ...
                    <td>
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu pull-right">
                                <li><a href="<?php echo U('modifypwd',array('id'=>$v['id']));?>">修改密码</a></li>
                            </ul>
                        </div>
                    </td>
