        ...
        <table class="table table-condensed table-hover tb-list">
            <thead>
                <tr>
                    ...
                    <th>商家名称</th>
                    <th class="th-150">联系人</th>
                    <th class="th-150">tel</th>
                    <th class="th-150">email</th>
                    <th class="th-400">地址</th>
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td><?php echo ($v["id"]); ?></td>
                    <td><a href="<?php echo U('edit',array('id'=>$v['id']));?>"><?php echo ($v["business_name"]); ?></a></td>
