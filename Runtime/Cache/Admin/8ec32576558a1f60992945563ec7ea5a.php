    ...
    <div class="table-responsive">
        <table class="table table-condensed table-hover tb-list">
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                    <td><?php echo ($v["id"]); ?></td>
                    <td><a href="<?php echo U('Member/edit',array('id'=>$v['id']));?>"><?php echo ((isset($v["account"]) && ($v["account"] !== ""))?($v["account"]):'== 未定义 =='); ?></a></td>
                    <td><?php echo ($v["username"]); ?></td>
                    <td><?php echo ($v["member_level"]); ?></td>
                    <td><?php echo (date('Y-m-d H:i',$v["register_time"])); ?></td>
                    <td>
                        <a href="<?php echo U('add',array('mid'=>$v['id']));?>" class="btn btn-success btn-xs"><?php echo L('CHOOSE');?></a>
                    </td>
