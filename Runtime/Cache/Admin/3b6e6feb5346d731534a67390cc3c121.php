        ...
        <table class="table table-condensed table-hover tb-list">
            <thead>
                <tr>
                    ...
                    <th class="th-200"><?php echo L('REMARK');?></th>
                    <th class="th-300">关联属性</th>
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td><?php echo ($v["id"]); ?></td>
                    <td><a href="<?php echo U('edit',array('id'=>$v['id']));?>"><?php echo ((isset($v["type_name"]) && ($v["type_name"] !== ""))?($v["type_name"]):'== 未定义 =='); ?></a></td>
                    <td><?php echo ($v["remark"]); ?></td>
                    <td><?php echo ($v["attribute_names"]); ?></td>
                    <td>
