        ...
        <tr>
            ...
            <td>
                <select name="role_id" class="form-control-sm">
                    <?php if(is_array($roles)): $i = 0; $__LIST__ = $roles;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v["id"]); ?>" <?php if(($role_id) == $v["id"]): ?>selected<?php endif; ?>><?php echo (do_sub_prefix($v["grade"])); echo ($v["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
            </td>
        </tr>
        <tr>
            <th><?php echo L('ACCOUNT');?></th>
            <td><input type="text" name="account" class="form-control-sm" /></td>
        </tr>
        <tr>
            <th><?php echo L('PASSWORD');?></th>
            <td><input type="text" name="password" class="form-control-sm" /></td>
        </tr>
    </table>
