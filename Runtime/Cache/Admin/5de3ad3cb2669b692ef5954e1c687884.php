            ...
            <table class="table table-condensed tb-data">
                <tr>
                    ...
                    <td>
                        ...
                        <label><input type="radio" name="display" value="0" <?php if(($data["display"]) == "0"): ?>checked<?php endif; ?> /> 多选</label>
                    </td>
                </tr>
                <tr>
                    <th><?php echo L('NAME');?></th>
                    <td><input type="text" name="attribute" value="<?php echo (htmlspecialchars($data["attribute"])); ?>" class="form-control-sm" /></td>
                </tr>
                <tr>
                    <th><?php echo L('ALIAS');?></th>
                    <td><input type="text" name="attribute_alias" value="<?php echo (htmlspecialchars($data["attribute_alias"])); ?>" class="form-control-sm" /></td>
                </tr>
                <tr>
                    <th><?php echo L('REMARK');?></th>
                    <td><textarea name="remark" class="form-control-sm"><?php echo (htmlspecialchars($data["remark"])); ?></textarea></td>
                </tr>
            </table>
        </div>
        <div class="tab-pane" id="pane2">
            <table class="table table-condensed table-bordered tb-data-list" id="js-attr-value-list" data-add-url="<?php echo U('AttributeValue/add',array('attrid'=>$data['id']));?>" data-remove-url="<?php echo U('AttributeValue/delete');?>">
                <thead>
                    <tr>
                ...
                <tbody>
                <?php if(is_array($data["_list"])): $i = 0; $__LIST__ = $data["_list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr data-id="<?php echo ($v["id"]); ?>">
                        <td><input type="text" name="values[<?php echo ($v["id"]); ?>][attribute_value]" value="<?php echo ($v["attribute_value"]); ?>" class="form-control-sm t-sm"></td>
                        <td class="f16">
                            ...
                            <input type="hidden" name="values[<?php echo ($v["id"]); ?>][id]" value="<?php echo ($v["id"]); ?>">
                        </td>
