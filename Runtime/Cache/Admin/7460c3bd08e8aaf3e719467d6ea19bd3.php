...
<div class="page-direction clearfix">
    ...
    <form action="<?php echo U('search');?>" method="get" class="list-search">
...
<form action="<?php echo U('handle');?>" method="post" id="js-form-handle">
    ...
    <div class="table-responsive">
        <table class="table table-condensed table-hover tb-list">
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td><?php echo ($v["id"]); ?></td>
                    <td><a href="<?php echo U('edit',array('id'=>$v['id']));?>"><?php echo ((isset($v["goods"]) && ($v["goods"] !== ""))?($v["goods"]):'== 未定义 =='); ?></a></td>
                    ...
                    <td>
                        ...
                        <a href="<?php echo U('recycle',array('id'=>$v['id']));?>" class="btn btn-danger btn-xs j-del"><?php echo L('RECYCLE');?></a>
                    </td>
    ...
    <div class="container-fluid">
        <div class='row'>
            <div class="col-md-4">
                <a href="javascript:;" data-type="recycle" class="btn btn-danger btn-sm js-handle js-need-confirm"><i class="glyphicon glyphicon-trash"></i> <?php echo L('RECYCLE');?></a>
            </div>
