...
<div class="content width">
    ...
    <div class="search">
        <form action="<?php echo U('/Search');?>" method="get">
            <input type="text" class="text" name="kw" placeholder="Search for Products..." style="width:155px;" />
            <button type="submit" class="submit"></button>
        </form>
    </div>
</div>
    ...
    <ul class="left_nav">
    <?php if(is_array($nav_list[CONTROLLER_NAME])): $i = 0; $__LIST__ = $nav_list[CONTROLLER_NAME];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li><a href="<?php if(empty($v["rewriteuri"])): echo U('category',array('id'=>$v['id'])); else: echo U('Product/category/'.$v['rewriteuri']); endif; ?>" <?php if(($article["id"]) == $v["id"]): ?>class="on"<?php endif; ?>><?php echo ($v["cate_name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
</ul>
    ...
    <ul class="line" id="j-siderCateList">
        ...
        <div class="right_side">
            <div class="right_menu clear">
                <a href="<?php echo U('/');?>" class="icon">Home</a> <span>/</span> <a href="<?php echo U('/Product');?>">Product</a>
                <div class="btn_share">
    ...
    <div class="editor_public clear">
        <div style="width:410px; float:left">
            <h3>As a major rare earth products producer, we have a full line of products.</h3>
            <p>
You can always navigate through the products using the menu at our <a href="http://kehongre.com/" style="font-weight:bold; color:#d07a00;">home page</a>.<br />
If you don't find what you need, please send us your requests, we do provide customized products.</p>
        </div>
        <img src="/hamanaka3/Public/Home/images/products_1.jpg">
    </div>
    <div class="intro_list">
        <?php if(is_array($nav_list["Product"])): $i = 0; $__LIST__ = $nav_list["Product"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="products_box clear">
            <div class="image"><img src="/hamanaka3/Uploads/<?php echo ($v["image"]); ?>"></div>
            <div class="content">
                <h3><a href="<?php if(empty($v["rewriteuri"])): echo U('category',array('id'=>$v['id'])); else: echo U('Product/category/'.$v['rewriteuri']); endif; ?>"><?php echo ($v["cate_name"]); ?></a></h3>
                <a href="<?php if(empty($v["rewriteuri"])): echo U('category',array('id'=>$v['id'])); else: echo U('Product/category/'.$v['rewriteuri']); endif; ?>"><img src="/hamanaka3/Public/Home/images/arrow_4.gif"></a>
            </div>
            <div class="text">
                <p><?php echo (nl2br($v["short_desc"])); ?></p>
            </div>
        </div><?php endforeach; endif; else: echo "" ;endif; ?>
    	<div><img src="/hamanaka3/Public/Home/images/zhouqibiao.jpg" width="830"></div>
    </div>
    <div class="inner_info clear">
    <div class="call">
        <h3>Contact Us</h3>
        <p>Please contact us for more information on 
            how KeHong can turn your creative visions 
            into reality.</p>
        <a href="<?php echo U('/Contact');?>">More info &gt;</a>
    </div>
    <div class="pdf">
        <h3>Download PDF</h3>
        <p>Your can download all PDF for free</p>
        <a href="<?php echo U('Info/downloads');?>">See all &gt;</a>
    </div>
</div>
